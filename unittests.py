...
class TestCompute(TestCase):
    ...
    def test_ComputeTable_evolve_vs_compute_difference_move(self):
        ...
        comp_evl.add_ball(0, 25, 0.100, (100, 100), (2, 90))
        comp_compute = ComputeTable(topleft=(0, 0), bottomright=(10000, 10000))
        comp_compute.add_ball(0, 25, 0.100, (100, 100), (2, 90))
        # act
        status = True
    ...
    def test_ComputeTable_evolve_move2(self):
        ...
        comp_evl1.add_ball(0, 25, 0.100, (102, 100), (0, 90))

        comp_evl2 = ComputeTable(topleft=(0, 0), bottomright=(10000, 10000))
        comp_evl2.add_ball(0, 25, 0.100, (102, 100), (0, 90))
        # act
        status = True
        time_delta = [6]
        evolve_result1 = ''
    ...
    def test_ComputeTable_evolve_move3_stop_time(self):
        """
        Результат по прошествии очевидно слишком большого времени и времени остановки должен быть одинаков
        """
        # arrange
        comp_evl = ComputeTable(topleft=(0, 0), bottomright=(10000, 10000))
        comp_evl.add_ball(0, 25, 0.100, (102, 100), (0, 90))
